...
7. Verify your Azure DevOps organization is connected to the same directory as your tenant under: `https://azure-devops.example.com/<organization>/_settings/organizationAad`
